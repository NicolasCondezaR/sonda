// Command echo is the toy upstream Sonda is developed and demoed against.
...
func main() {
	...
	// /slow?ms=1500 — for checking that Sonda reports duration and does not
	...
	// its real status instead of Sonda's own error.
	...
	mux.HandleFunc("POST /echo", func(w http.ResponseWriter, r *http.Request) {
		...
		// Echoed byte for byte, so a Sonda capture can be compared against
